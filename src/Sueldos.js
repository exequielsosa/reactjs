...
<Layout>
	<section className="main">
		...
		<section className="articles">
			...
			<article>
				<h2>Asesoramiento en liquidación de haberes y administración de personal</h2><br />
				<p>Este servicio comprende la realización de un amplio abanico de trámites y tareas
				inherentes a los procesos de incorporación, administración y egreso del personal de su empresa.
				Nosotros nos encargamos de la ejecución de estos procedimientos, o bien le ofrecemos asesoramiento
				sobre cómo llevarlos a cabo de una forma idónea para su compañía.</p><br />
				...
				<ul>
					...
					<li>Cálculo de haberes (esto incluye todos los convenios colectivos de trabajo)</li>
					<li>Cálculo de impuestos a las ganancias</li>
					<li>Estudio de beneficios promocionales (rebaja de cargas sociales)</li>
					<li>Confección de recibos de sueldos</li>
					<li>Confección y rubricación de libro de sueldos y jornales</li>
					<li>Liquidación y presentación de SUSS y demás cargas sociales</li>
					<li>Entrega mensual o quincenal de recibos y boletas de depósito para pagar las cargas sociales</li>
				</ul>
		...
		<aside>
			<div className="logosredes" align="center">
				...
				<div align="center" className="otroslinks">
					...
					<a href="http://www.afip.gov.ar" target="_blank"><img src="imgs/afip22.png" tag="afip" width="120" /></a>
				</div>
