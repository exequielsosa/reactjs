...
<Layout>
    <section className="main">
	    ...
	    <article>
		<h2>Impuestos y DDJJ de presentación</h2><br />
		<ul>
		...
		<h2>Gestiones</h2><br />
		<ul>
			<li>Regulación de deudas impositivas y/o previsionales de plazo vencido.</li>
			<li>Confección de planes de facilidades de pago.</li>
			<li>Reintegro por exportaciones.</li>
			<li>Devoluciones, transferencias y/o compensaciones con deudas exigibles o futuros ingresos.</li>
			<li>Inspecciones, minimización de los efectos y consideración de medidas preventivas.</li>
			<li>Asesoramiento y patrocinio en materia contencioso tributaria, tanto en la instancia administrativa como en la instancia judicial.</li>
		</ul>
        </article>
        </section>
